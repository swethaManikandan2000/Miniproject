...
class MyFirstGui(tk.Tk):
       ...
       def switch_frame(self, frame_class):
                ...
                self.configure(background='papayawhip')
...
# Create frames and labels in left_frame
                ...
                self.le2=ttk.Label(self.right_frame,text="Leaving Date",font=("Times 18 italic"),background="darkorchid")
                self.le2.grid(row=2,column=0,sticky='W',padx=10,pady=10,ipadx=20,ipady=10)
                self.ee2=ttk.Entry(self.right_frame,font=("Times 18 italic"))
                self.ee2.grid(row=2,column=1,padx=5,pady=5,ipady=5,sticky='W')
                self.le3=ttk.Label(self.right_frame,text="Year Of PassOut",font=("Times 18 italic"),background="darkorchid")
...
# Create frames and labels in left_frame
                ...
                self.e2=ttk.Entry(self.right_frame,font=("Times 15 italic"))
                self.e2.grid(row=2,column=1,padx=5,pady=1,ipady=5,sticky='W')
                self.vieww=tk.IntVar()
                self.viewe=tk.IntVar()
                self.viiew=tk.IntVar()
...
class edit(tk.Frame):
              def __init__(self, master):
                    ...
                    if(e):
                        ...
                        self.Frame1.configure(background='snow')                        
                        
                        self.labe=ttk.Label(self.Frame11,text="EDIT",font=("Times 15 bold"),background='snow')
                        self.labe.grid(row=0,column=0,sticky='W',pady=5,padx=35)
                        
                        self.Frame2 = tk.Frame(self.master)
                        self.Frame2.pack(side="left",ipady=40,expand=True )
                        self.Frame2.configure(background='snow')                        
                        
                        self.Frame4 = tk.Frame(self.Frame2)
                        self.Frame4.pack(side="top",expand=True,ipadx=15,ipady=0 )
                        self.Frame4.configure(background='MistyRose3')
                        
                        self.l1=ttk.Label(self.Frame4,text="Name Of The Candidate",font=("Times 14 italic"),background='MistyRose3')
                        self.l1.grid(row=1,column=0,sticky='W',pady=5,padx=20,ipady=5)
                        self.ll1=ttk.Label(self.Frame4,text=":",font=("Times 14 italic"),background='MistyRose3')
                        self.ll1.grid(row=1,column=1,sticky='W',pady=5,padx=20,ipady=5)
                        self.e1=ttk.Entry(self.Frame4,font=("Times 14 italic"),width=23)
                        self.e1.grid(row=1,column=2,sticky='W',padx=20,pady=5,ipady=3)
                        self.e1.insert(0,e[0])
                        
                        self.l4=ttk.Label(self.Frame4,text="Father's Name",font=("Times 14 italic"),background='MistyRose3')
                        self.l4.grid(row=2,column=0,sticky='W',pady=5,padx=20,ipady=5)
                        self.ll4=ttk.Label(self.Frame4,text=":",font=("Times 14 italic"),background='MistyRose3')
                        self.ll4.grid(row=2,column=1,sticky='W',pady=5,padx=20,ipady=5)
                        self.e4=ttk.Entry(self.Frame4,font=("Times 14 italic"),width=23)
                        self.e4.grid(row=2,column=2,sticky='W',padx=20,pady=3,ipady=3)
                        self.e4.insert(0,e[3])
                        
                        self.l9=ttk.Label(self.Frame4,text="Sex",font=("Times 14 italic"),background='MistyRose3')
                        self.l9.grid(row=3,column=0,sticky='W',pady=5,padx=20,ipady=5)
                        self.ll9=ttk.Label(self.Frame4,text=":",font=("Times 14 italic"),background='MistyRose3')
                        self.ll9.grid(row=3,column=1,sticky='W',pady=5,padx=20,ipady=5)
                        self.e9 = tk.StringVar(self)
                        self.p4 =ttk.Combobox(self.Frame4, width=21, textvariable=self.e9,font=("Times 14 italic"))
                        self.p4['values']=(e[8],'Male','Female','Others')  
                        self.p4.grid(row=3,column=2,sticky='W',padx=20,pady=5,ipady=5)
                        self.p4.current(0)
                           
                        self.l6=ttk.Label(self.Frame4,text="Religion",font=("Times 14 italic"),background='MistyRose3')
                        self.l6.grid(row=5,column=0,sticky='W',pady=5,padx=20,ipady=5)
                        self.ll6=ttk.Label(self.Frame4,text=":",font=("Times 14 italic"),background='MistyRose3')
                        self.ll6.grid(row=5,column=1,sticky='W',pady=5,padx=20,ipady=5)
                        self.e6 = tk.StringVar(self)
                        self.p2 =ttk.Combobox(self.Frame4, width=21, textvariable=self.e6,font=("Times 14 italic"))
                        self.p2['values']=(e[5],'Hindu','Musim','Christian','Others')
                        self.p2.grid(row=5,column=2,sticky='W',padx=20,pady=5,ipady=5)
                        self.p2.current(0)
                        
                        self.l7=ttk.Label(self.Frame4,text="Caste",font=("Times 14 italic"),background='MistyRose3')
                        self.l7.grid(row=6,column=0,sticky='W',pady=5,padx=20,ipady=5)
                        self.ll7=ttk.Label(self.Frame4,text=":",font=("Times 14 italic"),background='MistyRose3')
                        self.ll7.grid(row=6,column=1,sticky='W',pady=5,padx=20,ipady=5)
                        self.e7=ttk.Entry(self.Frame4,font=("Times 14 italic"),width=23)
                        self.e7.grid(row=6,column=2,sticky='W',padx=20,pady=3,ipady=3)
                        self.e7.insert(0,e[6])
                        
                        self.l8=ttk.Label(self.Frame4,text="Community",font=("Times 14 italic"),background='MistyRose3')
                        self.l8.grid(row=7,column=0,sticky='W',pady=5,padx=20,ipady=5)
                        self.ll8=ttk.Label(self.Frame4,text=":",font=("Times 14 italic"),background='MistyRose3')
                        self.ll8.grid(row=7,column=1,sticky='W',pady=5,padx=20,ipady=5)
                        self.e8 = tk.StringVar(self)
                        self.p3 =ttk.Combobox(self.Frame4, width=21, textvariable=self.e8,font=("Times 14 italic"))
                        self.p3['values']=(e[7],'OC','BC','BCM','MBC','SC','ST','Others')  
                        self.p3.grid(row=7,column=2,sticky='W',padx=20,pady=5,ipady=5)
                        self.p3.current(0)
                        
                        self.l14=ttk.Label(self.Frame4,text="Mother Tongue",font=("Times 14 italic"),background='MistyRose3')
                        self.l14.grid(row=8,column=0,sticky='W',pady=5,padx=20,ipady=5)
                        self.ll14=ttk.Label(self.Frame4,text=":",font=("Times 14 italic"),background='MistyRose3')
                        self.ll14.grid(row=8,column=1,sticky='W',pady=5,padx=20,ipady=5)
                        self.e16 = tk.StringVar(self)
                        self.p7 =ttk.Combobox(self.Frame4, width=21, textvariable=self.e16,font=("Times 14 italic"))
                        ...
                        self.Frame5.pack(side="bottom",expand=True,ipadx=15,ipady=1)
                        self.Frame5.configure(background='MistyRose3')
                        
                        self.l5=ttk.Label(self.Frame5,text="Nationality",font=("Times 14 italic"),background='MistyRose3')
                        self.l5.grid(row=1,column=0,sticky='W',pady=5,padx=20,ipady=5)
                        self.ll5=ttk.Label(self.Frame5,text="            :",font=("Times 14 italic"),background='MistyRose3')
                        self.ll5.grid(row=1,column=1,sticky='W',pady=5,padx=20,ipady=5)
                        self.e5 = tk.StringVar(self)
                        self.pp1 =ttk.Combobox(self.Frame5, width=21, textvariable=self.e5,font=("Times 14 italic"))
                        self.pp1['values']=(e[4],'Indian','Others')
                        self.pp1.grid(row=1,column=2,sticky='W',padx=20,pady=5,ipadx=2,ipady=5)
                        self.pp1.current(0)
                        
                        self.l14=ttk.Label(self.Frame5,text="Present address  ",font=("Times 14 italic"),background='MistyRose3')
                        self.l14.grid(row=2,column=0,sticky='W',pady=5,padx=20,ipady=5)
                        self.ll14=ttk.Label(self.Frame5,text="            :",font=("Times 14 italic"),background='MistyRose3')
                        self.ll14.grid(row=2,column=1,sticky='W',pady=5,padx=20,ipady=5)
                        self.e18=ttk.Entry(self.Frame5,font=("Times 14 italic"),width=23)
                        self.e18.grid(row=2,column=2,sticky='W',padx=20,pady=3,ipady=3)
                        self.e18.insert(0,e[17])

                        self.l19=ttk.Label(self.Frame5,text="Taluk ",font=("Times 14 italic"),background='MistyRose3')
                        self.l19.grid(row=3,column=0,sticky='W',pady=5,padx=20,ipady=5)
                        self.ll19=ttk.Label(self.Frame5,text="            :",font=("Times 14 italic"),background='MistyRose3')
                        self.ll19.grid(row=3,column=1,sticky='W',pady=5,padx=20,ipady=5)
                        self.e19=ttk.Entry(self.Frame5,font=("Times 14 italic"),width=23)
                        self.e19.grid(row=3,column=2,sticky='W',padx=20,pady=3,ipady=3)
                        self.e19.insert(0,e[18])

                        self.l20=ttk.Label(self.Frame5,text="City",font=("Times 14 italic"),background='MistyRose3')
                        self.l20.grid(row=4,column=0,sticky='W',pady=5,padx=20,ipady=5)
                        self.ll20=ttk.Label(self.Frame5,text="            :",font=("Times 14 italic"),background='MistyRose3')
                        self.ll20.grid(row=4,column=1,sticky='W',pady=5,padx=20,ipady=5)
                        self.e20=ttk.Entry(self.Frame5,font=("Times 14 italic"),width=23)
                        self.e20.grid(row=4,column=2,sticky='W',padx=20,pady=3,ipady=3)
                        self.e20.insert(0,e[19])

                        self.l21=ttk.Label(self.Frame5,text="District",font=("Times 14 italic"),background='MistyRose3')
                        self.l21.grid(row=5,column=0,sticky='W',pady=5,padx=20,ipady=5)
                        self.ll21=ttk.Label(self.Frame5,text="            :",font=("Times 14 italic"),background='MistyRose3')
                        self.ll21.grid(row=5,column=1,sticky='W',pady=5,padx=20,ipady=5)
                        self.e21= tk.StringVar(self)
                        self.p9 =ttk.Combobox(self.Frame5, width=21, textvariable=self.e21,font=("Times 14 italic"))
                        ...
                        self.l17=ttk.Label(self.Frame5,text="Name Of State",font=("Times 14 italic"),background='MistyRose3')
                        self.l17.grid(row=6,column=0,sticky='W',pady=5,padx=20,ipady=5)
                        self.ll17=ttk.Label(self.Frame5,text="            :",font=("Times 14 italic"),background='MistyRose3')
                        self.ll17.grid(row=6,column=1,sticky='W',pady=5,padx=20,ipady=5)
                        self.e17 = tk.StringVar(self)
                        self.p8 =ttk.Combobox(self.Frame5, width=21, textvariable=self.e17,font=("Times 14 italic"))
                        ...
                        self.Frame6.configure(background='snow')
                        
                        self.l100=ttk.Label(self.Frame6,text="",font=("Times 7 italic"),background='snow')
                        self.l100.grid(row=1,column=0,sticky='W')
                        
                        self.Frame3 = tk.Frame(self.master)
                        self.Frame3.pack(side="right",ipady=30,expand=True )
                        self.Frame3.configure(background='snow')                        
                        
                        self.Frame7 = tk.Frame(self.Frame3)
                        self.Frame7.pack(side="top",expand=True,ipadx=15)
                        self.Frame7.configure(background='MistyRose3')
                        
                        self.l10=ttk.Label(self.Frame7,text="Date Of Birth",font=("Times 14 italic"),background='MistyRose3')
                        self.l10.grid(row=1,column=0,sticky='W',pady=5,padx=20,ipady=5)
                        self.ll10=ttk.Label(self.Frame7,text="          :",font=("Times 14 italic"),background='MistyRose3')
                        self.ll10.grid(row=1,column=1,sticky='W',pady=5,padx=20,ipady=5)
                        self.e10=ttk.Entry(self.Frame7,font=("Times 14 italic"),width=23)
                        self.e10.grid(row=1,column=2,sticky='W',padx=20,pady=3,ipady=3)
                        self.e10.insert(0,e[9])
                        
                        self.la23=ttk.Label(self.Frame7,text="Aadhar Number",font=("Times 14 italic"),background='MistyRose3')
                        self.la23.grid(row=2,column=0,sticky='W',pady=5,padx=20,ipady=5)
                        self.lla23=ttk.Label(self.Frame7,text="          :",font=("Times 14 italic"),background='MistyRose3')
                        self.lla23.grid(row=2,column=1,sticky='W',pady=5,padx=20,ipady=5)
                        self.ea23=ttk.Entry(self.Frame7,font=("Times 14 italic"),width=23)
                        self.ea23.grid(row=2,column=2,sticky='W',padx=20,pady=3,ipady=3)
                        self.ea23.insert(0,e[22])
                        
                        self.la22=ttk.Label(self.Frame7,text="Cell Number",font=("Times 14 italic"),background='MistyRose3')
                        self.la22.grid(row=3,column=0,sticky='W',pady=5,padx=20,ipady=5)
                        self.lla22=ttk.Label(self.Frame7,text="          :",font=("Times 14 italic"),background='MistyRose3')
                        self.lla22.grid(row=3,column=1,sticky='W',pady=5,padx=20,ipady=5)
                        self.ea22=ttk.Entry(self.Frame7,font=("Times 14 italic"),width=23)
                        self.ea22.grid(row=3,column=2,sticky='W',padx=20,pady=3,ipady=3)
                        self.ea22.insert(0,e[21])
                        
                        self.l2=ttk.Label(self.Frame7,text="Reg Number",font=("Times 14 italic"),background='MistyRose3')
                        self.l2.grid(row=4,column=0,sticky='W',pady=5,padx=20,ipady=5)
                        self.ll2=ttk.Label(self.Frame7,text="          :",font=("Times 14 italic"),background='MistyRose3')
                        self.ll2.grid(row=4,column=1,sticky='W',pady=5,padx=20,ipady=5)
                        self.e2=ttk.Entry(self.Frame7,font=("Times 14 italic"),width=23)
                        self.e2.grid(row=4,column=2,sticky='W',padx=20,pady=3,ipady=3)
                        self.e2.insert(0,e[1])
                        
                        self.l3=ttk.Label(self.Frame7,text="Roll Number",font=("Times 14 italic"),background='MistyRose3')
                        self.l3.grid(row=5,column=0,sticky='W',pady=5,padx=20,ipady=5)
                        self.ll3=ttk.Label(self.Frame7,text="          :",font=("Times 14 italic"),background='MistyRose3')
                        self.ll3.grid(row=5,column=1,sticky='W',pady=5,padx=20,ipady=5)
                        self.e3=ttk.Entry(self.Frame7,font=("Times 14 italic"),width=23)
                        self.e3.grid(row=5,column=2,sticky='W',padx=20,pady=3,ipady=3)
                        self.e3.insert(0,e[2])
                        
                        self.l11=ttk.Label(self.Frame7,text="Course Of Study",font=("Times 14 italic"),background='MistyRose3')
                        self.l11.grid(row=6,column=0,sticky='W',pady=5,padx=20,ipady=5)
                        self.ll11=ttk.Label(self.Frame7,text="          :",font=("Times 14 italic"),background='MistyRose3')
                        self.ll11.grid(row=6,column=1,sticky='W',pady=5,padx=20,ipady=5)
                        self.e11 = tk.StringVar(self)
                        self.p5 =ttk.Combobox(self.Frame7, width=21, textvariable=self.e11,font=("Times 14 italic"))
                        self.p5['values']=(e[10],'BE','ME','BE Parttime')  
                        self.p5.grid(row=6,column=2,sticky='W',padx=20,pady=5,ipady=5)
                        self.p5.current(0)
                        
                        self.l12=ttk.Label(self.Frame7,text="Branch Of Study",font=("Times 14 italic"),background='MistyRose3')
                        self.l12.grid(row=7,column=0,sticky='W',pady=5,padx=20,ipady=5)
                        self.ll12=ttk.Label(self.Frame7,text="          :",font=("Times 14 italic"),background='MistyRose3')
                        self.ll12.grid(row=7,column=1,sticky='W',pady=5,padx=20,ipady=5)
                        self.e12 = tk.StringVar(self)
                        self.p6 =ttk.Combobox(self.Frame7,width=21, textvariable=self.e12,font=("Times 14 italic"))
                        ...
                        self.Frame8.pack(side="top",expand=True,ipadx=15)
                        self.Frame8.configure(background='MistyRose3')
                        
                        self.l13=ttk.Label(self.Frame8,text=" Admitted On ",font=("Times 14 italic"),background='MistyRose3')
                        self.l13.grid(row=1,column=0,sticky='W',pady=5,padx=20,ipady=5)
                        self.ll13=ttk.Label(self.Frame8,text="           :",font=("Times 14 italic"),background='MistyRose3')
                        self.ll13.grid(row=1,column=1,sticky='W',pady=5,padx=20,ipady=5)
                        self.e13=ttk.Entry(self.Frame8,font=("Times 14 italic"),width=23)
                        self.e13.grid(row=1,column=2,sticky='W',padx=20,pady=3,ipady=3)
                        self.e13.insert(0,e[12])
                        
                        self.l14=ttk.Label(self.Frame8,text="Receipt Number",font=("Times 14 italic"),background='MistyRose3')
                        self.l14.grid(row=2,column=0,sticky='W',pady=5,padx=20,ipady=5)
                        self.ll14=ttk.Label(self.Frame8,text="           :",font=("Times 14 italic"),background='MistyRose3')
                        self.ll14.grid(row=2,column=1,sticky='W',pady=5,padx=20,ipady=5)
                        self.e14=ttk.Entry(self.Frame8,font=("Times 14 italic"),width=23)
                        self.e14.grid(row=2,column=2,sticky='W',padx=20,pady=3,ipady=3)
                        self.e14.insert(0,e[13])

                        self.l15=ttk.Label(self.Frame8,text="Receipt Date",font=("Times 14 italic"),background='MistyRose3')
                        self.l15.grid(row=3,column=0,sticky='W',pady=5,padx=20,ipady=5)
                        self.ll15=ttk.Label(self.Frame8,text="           :",font=("Times 14 italic"),background='MistyRose3')
                        self.ll15.grid(row=3,column=1,sticky='W',pady=5,padx=20,ipady=5)
                        self.e15=ttk.Entry(self.Frame8,font=("Times 14 italic"),width=23)
                        self.e15.grid(row=3,column=2,sticky='W',padx=20,pady=3,ipady=3)
                        self.e15.insert(0,e[14])

                        self.la25=ttk.Label(self.Frame8,text="Issued ON",font=("Times 14 italic"),background='MistyRose3')
                        self.la25.grid(row=4,column=0,sticky='W',pady=5,padx=20,ipady=5)
                        self.lla25=ttk.Label(self.Frame8,text="           :",font=("Times 14 italic"),background='MistyRose3')
                        self.lla25.grid(row=4,column=1,sticky='W',pady=5,padx=20,ipady=5)
                        self.ea25=ttk.Entry(self.Frame8,font=("Times 14 italic"),width=23)
                        self.ea25.grid(row=4,column=2,sticky='W',padx=20,pady=3,ipady=3)
                        self.ea25.insert(0,e[24])
                         
                        self.la24=ttk.Label(self.Frame8,text="T.C.No",font=("Times 14 italic"),background='MistyRose3')
                        self.la24.grid(row=5,column=0,sticky='W',pady=5,padx=20,ipady=5)
                        self.lla24=ttk.Label(self.Frame8,text="           :",font=("Times 14 italic"),background='MistyRose3')
                        self.lla24.grid(row=5,column=1,sticky='W',pady=5,padx=20,ipady=5)
                        self.ea24=ttk.Entry(self.Frame8,font=("Times 14 italic"),width=23)
                        self.ea24.grid(row=5,column=2,sticky='W',padx=20,pady=3,ipady=3)
                        self.ea24.insert(0,e[23]) 
                        
                        self.Frame9 = tk.Frame(self.Frame3)
                        self.Frame9.pack(side="bottom",expand=True,ipadx=20)
                        self.Frame9.configure(background='snow')
...
class newreg(tk.Frame):
              def __init__(self, master):
                ...
                self.labe=ttk.Label(self.Frame11,text="INSERT RECORD",font=("Times 15 bold"),background='snow')
                self.labe.grid(row=0,column=0,sticky='W',pady=5,padx=35)
                        
                self.Frame2 = tk.Frame(self.master)
                self.Frame2.pack(side="left",ipady=30,expand=True )
                self.Frame2.configure(background='snow')                        
                ...
                self.l1=ttk.Label(self.Frame4,text="Name Of The Candidate",font=("Times 12 italic"),background='MistyRose3')
                self.l1.grid(row=1,column=0,sticky='W',pady=5,padx=20,ipady=5)
                self.ll1=ttk.Label(self.Frame4,text=":",font=("Times 12 italic"),background='MistyRose3')
                self.ll1.grid(row=1,column=1,sticky='W',pady=5,padx=20,ipady=5)
                self.e1=ttk.Entry(self.Frame4,font=("Times 12 italic"),width=24)
                self.e1.grid(row=1,column=2,sticky='W',padx=20,pady=5,ipady=3)
                
                self.l4=ttk.Label(self.Frame4,text="Father's Name",font=("Times 12 italic"),background='MistyRose3')
                self.l4.grid(row=2,column=0,sticky='W',pady=5,padx=20,ipady=5)
                self.ll4=ttk.Label(self.Frame4,text=":",font=("Times 12 italic"),background='MistyRose3')
                self.ll4.grid(row=2,column=1,sticky='W',pady=5,padx=20,ipady=5)
                self.e4=ttk.Entry(self.Frame4,font=("Times 12 italic"),width=24)
                self.e4.grid(row=2,column=2,sticky='W',padx=20,pady=3,ipady=3)
                
                self.l9=ttk.Label(self.Frame4,text="Sex",font=("Times 12 italic"),background='MistyRose3')
                self.l9.grid(row=3,column=0,sticky='W',pady=5,padx=20,ipady=5)
                self.ll9=ttk.Label(self.Frame4,text=":",font=("Times 12 italic"),background='MistyRose3')
                self.ll9.grid(row=3,column=1,sticky='W',pady=5,padx=20,ipady=5)
                self.t4 = tk.StringVar(self)
                self.p4 =ttk.Combobox(self.Frame4, width=21, textvariable=self.t4,font=("Times 12 italic"))
                self.p4['values']=('Male','Female','Others')  
                self.p4.grid(row=3,column=2,sticky='W',padx=20,pady=5,ipadx=2,ipady=5)
                self.p4.current()
                self.l7=ttk.Label(self.Frame4,text="Caste",font=("Times 12 italic"),background='MistyRose3')
                self.l7.grid(row=6,column=0,sticky='W',pady=5,padx=20,ipady=5)
                self.ll7=ttk.Label(self.Frame4,text=":",font=("Times 12 italic"),background='MistyRose3')
                self.ll7.grid(row=6,column=1,sticky='W',pady=5,padx=20,ipady=5)
                self.e7=ttk.Entry(self.Frame4,font=("Times 12 italic"),width=24)
                self.e7.grid(row=6,column=2,sticky='W',padx=20,pady=3,ipady=3)
                        
                
                self.l6=ttk.Label(self.Frame4,text="Religion",font=("Times 12 italic"),background='MistyRose3')
                self.l6.grid(row=5,column=0,sticky='W',pady=5,padx=20,ipady=5)
                self.ll6=ttk.Label(self.Frame4,text=":",font=("Times 12 italic"),background='MistyRose3')
                self.ll6.grid(row=5,column=1,sticky='W',pady=5,padx=20,ipady=5)
                self.t2 = tk.StringVar(self)
                self.p2 =ttk.Combobox(self.Frame4, width=21, textvariable=self.t2,font=("Times 12 italic"))
                self.p2['values']=('Hindu','Musim','Christian','Others')
                self.p2.grid(row=5,column=2,sticky='W',padx=20,pady=5,ipadx=2,ipady=5)
                self.p2.current()
                
                self.l8=ttk.Label(self.Frame4,text="Community",font=("Times 12 italic"),background='MistyRose3')
                self.l8.grid(row=7,column=0,sticky='W',pady=5,padx=20,ipady=5)
                self.ll8=ttk.Label(self.Frame4,text=":",font=("Times 12 italic"),background='MistyRose3')
                self.ll8.grid(row=7,column=1,sticky='W',pady=5,padx=20,ipady=5)
                self.t3 = tk.StringVar(self)
                self.p3 =ttk.Combobox(self.Frame4, width=21, textvariable=self.t3,font=("Times 12 italic"))
                self.p3['values']=('OC','BC','BCM','MBC','SC','ST','Others')  
                self.p3.grid(row=7,column=2,sticky='W',padx=20,pady=5,ipadx=2,ipady=5)
                self.p3.current()
                
                self.l14=ttk.Label(self.Frame4,text="Mother Tongue",font=("Times 12 italic"),background='MistyRose3')
                self.l14.grid(row=8,column=0,sticky='W',pady=5,padx=20,ipady=5)
                self.ll14=ttk.Label(self.Frame4,text=":",font=("Times 12 italic"),background='MistyRose3')
                self.ll14.grid(row=8,column=1,sticky='W',pady=5,padx=20,ipady=5)
                self.t7 = tk.StringVar(self)
                self.p7 =ttk.Combobox(self.Frame4, width=21, textvariable=self.t7,font=("Times 12 italic"))
                ...
                self.l5=ttk.Label(self.Frame5,text="Nationality",font=("Times 12 italic"),background='MistyRose3')
                self.l5.grid(row=1,column=0,sticky='W',pady=5,padx=20,ipady=5)
                self.ll5=ttk.Label(self.Frame5,text="            :",font=("Times 12 italic"),background='MistyRose3')
                self.ll5.grid(row=1,column=1,sticky='W',pady=5,padx=20,ipady=5)
                self.t1 = tk.StringVar(self)
                self.pp1 =ttk.Combobox(self.Frame5, width=21, textvariable=self.t1,font=("Times 12 italic"))
                self.pp1['values']=('Indian','Others')
                self.pp1.grid(row=1,column=2,sticky='W',padx=20,pady=5,ipadx=2,ipady=5)
                self.pp1.current()
                
                self.l14=ttk.Label(self.Frame5,text="Present address  ",font=("Times 12 italic"),background='MistyRose3')
                self.l14.grid(row=2,column=0,sticky='W',pady=5,padx=20,ipady=5)
                self.ll14=ttk.Label(self.Frame5,text="            :",font=("Times 12 italic"),background='MistyRose3')
                self.ll14.grid(row=2,column=1,sticky='W',pady=5,padx=20,ipady=5)
                self.e18=ttk.Entry(self.Frame5,font=("Times 12 italic"),width=24)
                self.e18.grid(row=2,column=2,sticky='W',padx=20,pady=3,ipady=3)
                
                self.l19=ttk.Label(self.Frame5,text="Taluk ",font=("Times 12 italic"),background='MistyRose3')
                self.l19.grid(row=3,column=0,sticky='W',pady=5,padx=20,ipady=5)
                self.ll19=ttk.Label(self.Frame5,text="            :",font=("Times 12 italic"),background='MistyRose3')
                self.ll19.grid(row=3,column=1,sticky='W',pady=5,padx=20,ipady=5)
                self.e19=ttk.Entry(self.Frame5,font=("Times 12 italic"),width=24)
                self.e19.grid(row=3,column=2,sticky='W',padx=20,pady=3,ipady=3)
                              

                self.l20=ttk.Label(self.Frame5,text="City",font=("Times 12 italic"),background='MistyRose3')
                self.l20.grid(row=4,column=0,sticky='W',pady=5,padx=20,ipady=5)
                self.ll20=ttk.Label(self.Frame5,text="            :",font=("Times 12 italic"),background='MistyRose3')
                self.ll20.grid(row=4,column=1,sticky='W',pady=5,padx=20,ipady=5)
                self.e20=ttk.Entry(self.Frame5,font=("Times 12 italic"),width=24)
                self.e20.grid(row=4,column=2,sticky='W',padx=20,pady=3,ipady=3)            
            
               
                self.l21=ttk.Label(self.Frame5,text="District",font=("Times 12 italic"),background='MistyRose3')
                self.l21.grid(row=5,column=0,sticky='W',pady=5,padx=20,ipady=5)
                self.ll21=ttk.Label(self.Frame5,text="            :",font=("Times 12 italic"),background='MistyRose3')
                self.ll21.grid(row=5,column=1,sticky='W',pady=5,padx=20,ipady=5)
                self.t9= tk.StringVar(self)
                self.p9 =ttk.Combobox(self.Frame5, width=21, textvariable=self.t9,font=("Times 12 italic"))
                ...
                self.l17=ttk.Label(self.Frame5,text="Name Of State",font=("Times 12 italic"),background='MistyRose3')
                self.l17.grid(row=6,column=0,sticky='W',pady=5,padx=20,ipady=5)
                self.ll17=ttk.Label(self.Frame5,text="            :",font=("Times 12 italic"),background='MistyRose3')
                self.ll17.grid(row=6,column=1,sticky='W',pady=5,padx=20,ipady=5)
                self.t8 = tk.StringVar(self)
                self.p8 =ttk.Combobox(self.Frame5, width=21, textvariable=self.t8,font=("Times 12 italic"))
                ...
                self.l10=ttk.Label(self.Frame7,text="Date Of Birth",font=("Times 12 italic"),background='MistyRose3')
                self.l10.grid(row=1,column=0,sticky='W',pady=5,padx=20,ipady=5)
                self.ll10=ttk.Label(self.Frame7,text="          :",font=("Times 12 italic"),background='MistyRose3')
                self.ll10.grid(row=1,column=1,sticky='W',pady=5,padx=20,ipady=5)
                self.e10=ttk.Entry(self.Frame7,font=("Times 12 italic"),width=24)
                self.e10.grid(row=1,column=2,sticky='W',padx=20,pady=3,ipady=3)
                                
                        
                self.la23=ttk.Label(self.Frame7,text="Aadhar Number",font=("Times 12 italic"),background='MistyRose3')
                self.la23.grid(row=2,column=0,sticky='W',pady=5,padx=20,ipady=5)
                self.lla23=ttk.Label(self.Frame7,text="          :",font=("Times 12 italic"),background='MistyRose3')
                self.lla23.grid(row=2,column=1,sticky='W',pady=5,padx=20,ipady=5)
                self.ea23=ttk.Entry(self.Frame7,font=("Times 12 italic"),width=24)
                self.ea23.grid(row=2,column=2,sticky='W',padx=20,pady=3,ipady=3)
                                                
                self.la22=ttk.Label(self.Frame7,text="Cell Number",font=("Times 12 italic"),background='MistyRose3')
                self.la22.grid(row=3,column=0,sticky='W',pady=5,padx=20,ipady=5)
                self.lla22=ttk.Label(self.Frame7,text="          :",font=("Times 12 italic"),background='MistyRose3')
                self.lla22.grid(row=3,column=1,sticky='W',pady=5,padx=20,ipady=5)
                self.ea22=ttk.Entry(self.Frame7,font=("Times 12 italic"),width=24)
                self.ea22.grid(row=3,column=2,sticky='W',padx=20,pady=3,ipady=3)
                
                self.l2=ttk.Label(self.Frame7,text="Reg Number",font=("Times 12 italic"),background='MistyRose3')
                self.l2.grid(row=4,column=0,sticky='W',pady=5,padx=20,ipady=5)
                self.ll2=ttk.Label(self.Frame7,text="          :",font=("Times 12 italic"),background='MistyRose3')
                self.ll2.grid(row=4,column=1,sticky='W',pady=5,padx=20,ipady=5)
                self.e2=ttk.Entry(self.Frame7,font=("Times 12 italic"),width=24)
                self.e2.grid(row=4,column=2,sticky='W',padx=20,pady=3,ipady=3)
                                        
                self.l3=ttk.Label(self.Frame7,text="Roll Number",font=("Times 12 italic"),background='MistyRose3')
                self.l3.grid(row=5,column=0,sticky='W',pady=5,padx=20,ipady=5)
                self.ll3=ttk.Label(self.Frame7,text="          :",font=("Times 12 italic"),background='MistyRose3')
                self.ll3.grid(row=5,column=1,sticky='W',pady=5,padx=20,ipady=5)
                self.e3=ttk.Entry(self.Frame7,font=("Times 12 italic"),width=24)
                self.e3.grid(row=5,column=2,sticky='W',padx=20,pady=3,ipady=3)
                
                self.l11=ttk.Label(self.Frame7,text="Course Of Study",font=("Times 12 italic"),background='MistyRose3')
                self.l11.grid(row=6,column=0,sticky='W',pady=5,padx=20,ipady=5)
                self.ll11=ttk.Label(self.Frame7,text="          :",font=("Times 12 italic"),background='MistyRose3')
                self.ll11.grid(row=6,column=1,sticky='W',pady=5,padx=20,ipady=5)
                self.t5 = tk.StringVar(self)
                self.p5 =ttk.Combobox(self.Frame7, width=21, textvariable=self.t5,font=("Times 12 italic"))
                self.p5['values']=('BE','ME','BE Parttime')  
                self.p5.grid(row=6,column=2,sticky='W',padx=20,pady=5,ipadx=2,ipady=5)
                self.p5.current()
                        
                self.l12=ttk.Label(self.Frame7,text="Branch Of Study",font=("Times 12 italic"),background='MistyRose3')
                self.l12.grid(row=7,column=0,sticky='W',pady=5,padx=20,ipady=5)
                self.ll12=ttk.Label(self.Frame7,text="          :",font=("Times 12 italic"),background='MistyRose3')
                self.ll12.grid(row=7,column=1,sticky='W',pady=5,padx=20,ipady=5)
                self.t6 = tk.StringVar(self)
                self.p6 =ttk.Combobox(self.Frame7,width=21, textvariable=self.t6,font=("Times 12 italic"))
                self.p6['values']=('Civil Engineering','Mechanical Engineering','Electrical and Electronics Engineering','Electronics and Communication Engineering','Computer science and Engineering')  
                self.p6.grid(row=7,column=2,sticky='W',padx=20,pady=5,ipadx=2,ipady=5)
                self.p6.current()
                
                self.la26=ttk.Label(self.Frame7,text="Year Of Completion",font=("Times 12 italic"),background='MistyRose3')
                self.la26.grid(row=8,column=0,sticky='W',pady=5,padx=20,ipady=5)
                self.lla26=ttk.Label(self.Frame7,text="          :",font=("Times 12 italic"),background='MistyRose3')
                self.lla26.grid(row=8,column=1,sticky='W',pady=5,padx=20,ipady=5)
                self.ea26=ttk.Entry(self.Frame7,font=("Times 12 italic"),width=24)
                ...
                self.l13=ttk.Label(self.Frame8,text=" Admitted On ",font=("Times 12 italic"),background='MistyRose3')
                self.l13.grid(row=1,column=0,sticky='W',pady=5,padx=20,ipady=5)
                self.ll13=ttk.Label(self.Frame8,text="                : ",font=("Times 12 italic"),background='MistyRose3')
                self.ll13.grid(row=1,column=1,sticky='W',pady=5,padx=20,ipady=5)
                self.e13=ttk.Entry(self.Frame8,font=("Times 12 italic"),width=24)
                self.e13.grid(row=1,column=2,sticky='W',padx=20,pady=3,ipady=3)
                                        
                self.l14=ttk.Label(self.Frame8,text="Receipt Number",font=("Times 12 italic"),background='MistyRose3')
                self.l14.grid(row=2,column=0,sticky='W',pady=5,padx=20,ipady=5)
                self.ll14=ttk.Label(self.Frame8,text="                : ",font=("Times 12 italic"),background='MistyRose3')
                self.ll14.grid(row=2,column=1,sticky='W',pady=5,padx=20,ipady=5)
                self.e14=ttk.Entry(self.Frame8,font=("Times 12 italic"),width=24)
                self.e14.grid(row=2,column=2,sticky='W',padx=20,pady=3,ipady=3)
                
                self.l15=ttk.Label(self.Frame8,text="Receipt Date",font=("Times 12 italic"),background='MistyRose3')
                self.l15.grid(row=3,column=0,sticky='W',pady=5,padx=20,ipady=5)
                self.ll15=ttk.Label(self.Frame8,text="                : ",font=("Times 12 italic"),background='MistyRose3')
                self.ll15.grid(row=3,column=1,sticky='W',pady=5,padx=20,ipady=5)
                self.e15=ttk.Entry(self.Frame8,font=("Times 12 italic"),width=24)
                self.e15.grid(row=3,column=2,sticky='W',padx=20,pady=3,ipady=3)

                self.la25=ttk.Label(self.Frame8,text="Issued ON",font=("Times 12 italic"),background='MistyRose3')
                self.la25.grid(row=4,column=0,sticky='W',pady=5,padx=20,ipady=5)
                self.lla25=ttk.Label(self.Frame8,text="                : ",font=("Times 12 italic"),background='MistyRose3')
                self.lla25.grid(row=4,column=1,sticky='W',pady=5,padx=20,ipady=5)
                self.ea25=ttk.Entry(self.Frame8,font=("Times 12 italic"),width=24)
                self.ea25.grid(row=4,column=2,sticky='W',padx=20,pady=3,ipady=3)
                                         
                self.la24=ttk.Label(self.Frame8,text="T.C.No",font=("Times 12 italic"),background='MistyRose3')
                self.la24.grid(row=5,column=0,sticky='W',pady=5,padx=20,ipady=5)
                self.lla24=ttk.Label(self.Frame8,text="                : ",font=("Times 12 italic"),background='MistyRose3')
                self.lla24.grid(row=5,column=1,sticky='W',pady=5,padx=20,ipady=5)
                self.ea24=ttk.Entry(self.Frame8,font=("Times 12 italic"),width=24)
                self.ea24.grid(row=5,column=2,sticky='W',padx=20,pady=3,ipady=3)
...
class search(tk.Frame):
                  def __init__(self, master):
                      ...
                      self.Frame1.configure(background='papayawhip')
                      ...
                      self.configure(background='papayawhip')
                      self.la=ttk.Label(self,text="search",font=("Times 25 italic"),background='papayawhip')
                      self.la.grid(row=0,column=5,sticky='W',padx=10,pady=10,ipadx=20,ipady=10)
                      self.la1=ttk.Label(self,text="Register",font=("Times 20 italic"),background='papayawhip')
                      self.la1.grid(row=1,column=4,sticky='W',padx=10,pady=5,ipadx=20,ipady=5)
                      self.en =ttk.Entry(self,font=("Times 11 italic"))
                      self.en.grid(row=1,column=5,sticky='W',padx=20,pady=5,ipadx=40,ipady=5)

                      self.la1=ttk.Label(self,text="Religion",font=("Times 20 italic"),background='papayawhip')
                      self.la1.grid(row=2,column=4,sticky='W',padx=10,pady=5,ipadx=20,ipady=5)
                      self.tkv1 = tk.StringVar(self)
                      self.popupMenu1 =ttk.Combobox(self, width=18, textvariable=self.tkv1,font=("Times 15 italic"))
                      ...
                      self.la2=ttk.Label(self,text="Community",font=("Times 20 italic"),background='papayawhip')
                      self.la2.grid(row=3,column=4,sticky='W',padx=10,pady=5,ipadx=20,ipady=5)
                      self.tkv2 = tk.StringVar(self)
                      self.popupMenu2 =ttk.Combobox(self, width=18, textvariable=self.tkv2,font=("Times 15 italic"))
                      ...
                      self.la3=ttk.Label(self,text="Gender",font=("Times 20 italic"),background='papayawhip')
                      self.la3.grid(row=4,column=4,sticky='W',padx=10,pady=5,ipadx=20,ipady=5)
                      self.tkv3 = tk.StringVar(self)
                      self.popupMenu3 =ttk.Combobox(self, width=18, textvariable=self.tkv3,font=("Times 15 italic"))
                      ...
                      self.la4=ttk.Label(self,text="Branch Of Study",font=("Times 20 italic"),background='papayawhip')
                      self.la4.grid(row=6,column=4,sticky='W',padx=10,pady=5,ipadx=20,ipady=5)
                      self.tkv5 = tk.StringVar(self)
                      self.popupMenu5=ttk.Combobox(self, width=18, textvariable=self.tkv5,font=("Times 15 italic"))
                      ...
                      self.la6=ttk.Label(self,text="Taluk",font=("Times 20 italic"),background='papayawhip')
                      self.la6.grid(row=7,column=4,sticky='W',padx=10,pady=5,ipadx=20,ipady=5)
                      self.eta5=ttk.Entry(self,font=("Times 11 italic"))
                      self.eta5.grid(row=7,column=5,sticky='W',padx=20,pady=5,ipadx=40,ipady=5)
                      self.la7=ttk.Label(self,text="District",font=("Times 20 italic"),background='papayawhip')
                      self.la7.grid(row=5,column=4,sticky='W',padx=10,pady=5,ipadx=20,ipady=5)
                      self.tkvar = tk.StringVar(self)
                      self.popupMenu =ttk.Combobox(self, width=18, textvariable=self.tkvar,font=("Times 15 italic"))
                      ...
                      self.la8=ttk.Label(self,text="Year Of Completion",font=("Times 20 italic"),background='papayawhip')
                      self.la8.grid(row=8,column=4,sticky='W',padx=10,pady=5,ipadx=20,ipady=5)
                      self.en1 =ttk.Entry(self,font=("Times 11 italic"))
                      self.en1.grid(row=8,column=5,sticky='W',padx=20,pady=5,ipadx=40,ipady=5)
                      self.l11=ttk.Label(self,text="Course Of Study",font=("Times 20 italic"),background="papayawhip")
                      self.l11.grid(row=9,column=4,sticky='W',padx=10,pady=5,ipadx=20,ipady=5)
                      self.t5 = tk.StringVar(self)
                      self.p5 =ttk.Combobox(self, width=18, textvariable=self.t5,font=("Times 15 italic"))
                      self.p5['values']=('BE','ME','BE Parttime')  
